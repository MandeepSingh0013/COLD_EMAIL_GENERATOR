...
class EmailGeneratorApp:
    ...
    def show_navigation(self, logged_in):
        ...
        if logged_in:
            ...
            dashboard_page = st.Page(self.show_dashboard, title="Dashboard", icon=":material/mail:")
...
#         # Navigation based on login status
#         if st.session_state.logged_in:
#             self.show_navigation([{"Account": [logout_page], "Dashboard": [dashboard_page]}])
#             self.display_user_type_selection()
#         else:
#             self.show_navigation([login_page])

#     def show_navigation(self, pages):
#         """Displays navigation options based on user login status."""
#         navigation = st.navigation(pages)
#         navigation.run()

#     def display_user_type_selection(self):
#         """Allows the user to select their type and updates configuration accordingly."""
#         try:
#             previous_user_type = st.session_state.user_type
#             user_type = st.sidebar.radio(
#                 "I am a...",
...
#     def show_dashboard(self):
#         """Displays the dashboard page where the ColdMailGenerator can be accessed."""
#         if st.session_state.logged_in:
#             try:
#                 app = ColdMailGenerator()
#                 app.run()
